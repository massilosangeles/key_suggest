...
<html>
  ...
  <body>
    <div class="row">
      ...
      <legend class="col-md-6">Keyword Suggestion</legend>
      <div class="col-md-3"></div>
    </div>
    <div class="row">
      <div class="col-md-3"></div>
      <div class="col-md-6">
        <span class="help-block">NOTHING ACTUALLY</span><br/>
      </div>
      <div class="col-md-3"></div>
    </div>
    <form id="form_snoop" class="form-horizontal" action="keywordgen.php" method="post">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <!-- Change data-sitekey with public key of your api google-->
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <button id="submit" name="submit" class="btn btn-primary">Suggest Key Words</button>
          </div>
        </div>
      </fieldset>
    </form>
    ...
    <div class="row" id="resultat">
      <div class="col-md-3"></div>
      <div class="form-group col-md-6" class="table-responsive">
        <label for="resultat_area"></label>
        <table id="resultat_tab" class="table">
